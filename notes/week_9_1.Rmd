...
`r margin_note("As usual, I'm clueless about the application (which would be very bad in a real-world project), but this is just to learn about unreplicated designs.")` 
```{r}
